  ...
  */
  ...
  exports.api = {
    listenSupported: function() {
      var _ref;
      return ((_ref = chrome.socket) != null ? _ref.listen : void 0) && chrome.experimental;
    },
    acceptSupported: function() {
      var _ref;
      return ((_ref = chrome.socket) != null ? _ref.accept : void 0) && chrome.experimental;
    },
    ...
    getNetworkListSupported: function() {
      var _ref;
      return (_ref = chrome.socket) != null ? _ref.getNetworkList : void 0;
    }
  };
